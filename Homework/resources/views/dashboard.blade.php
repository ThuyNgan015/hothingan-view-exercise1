        ...
        <div class="row">
            <div class="col-2">
                <div class='logo p-3' style="background-color: #fff;width:10rem;color:darkcyan;font-size:large;font-weight:bold;">
                    <img src="https://media.istockphoto.com/id/941624340/vector/finance-icon.jpg?s=612x612&w=0&k=20&c=YbWMt9NnuWnxEmN7J9cB8O4Hx1qHIavF1wYkyVh7caM=" alt="Ảnh" style="width:50px;height:50px;border-radius:50%;">
                    Finance
                </div>
                <div class="mt-4">
                    ...
                    <div class='m-3'>
                        <div class="row d-flex align-items-center justify-content-between">
                            ...
                            <div class='col-sm-4  d-flex align-items-center justify-content-between'>
                                ...
                                <img src="https://www.vietnamworks.com/hrinsider/wp-content/uploads/2023/12/anh-cute-001-1-1.jpg" alt="avatar" style="width: 50px;height:50px;border-radius:50%;">
                            </div>
                        </div>
                    </div>
                </div>
